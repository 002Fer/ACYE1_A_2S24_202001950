...
itoa_func:
    // params: x0 => num_funcber, x1 => buffer_func address
    ...
    cont:
        CMP x0, 0  // num_funcero a convertir
    ...
    i_endConversion:
        ADD x10, x10, x12
        print 1, num_func, x10
        RET

atoi_func:
    // params: x5, x8 => buffer_func address
    SUB x5, x5, 1
    a_c_digits:
        LDRB w7, [x8], 1
        CBZ w7, a_c_convert
...
proc_sum:
    // limpiar variable para almacenar num_funceros
    STP x29, x30, [SP, -16]!
    BL proc_cls_num_func
    LDP x29, x30, [SP], 16
    //SUMA A65 Y B54
...
proc_fill:
    ...
    get_cell:
        ...
        getRowCell:
            ...
            CMP w2, 32
            BEQ convert_num_func_cell

            STRB w2, [x0], 1
            
            B getRowCell

        convert_num_func_cell:
            LDR x5, =num_func
            LDR x8, =num_func
    ...
    get_cell_2:
        ...
        get_row_cell_2:
            ...
            CMP w2, 10
            BEQ convert_num_func_cell_2

            STRB w2, [x0], 1
            
            B get_row_cell_2

        convert_num_func_cell_2:
            LDR x5, =num_func
            LDR x8, =num_func
